    ...
    \begin{solution}
        \begin{enumerate}[(a)]
            ...
            \item \begin{align*}
                ...
                \end{bmatrix}
            \end{align*}
            So, the probability of rain the day after tomorrow is 
            $$\Pr(R_{i+2})=\alpha^2p+(1-\alpha)(1-\beta)p+\alpha(1-\beta)(1-p)+(1-\beta)\beta(1-p). $$ 
            \item We first calculate (In fact, I use WolframAlpha to calculate it): 
            \begin{align*}
